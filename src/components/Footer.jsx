    ...
    <footer className="bg-primary-800 text-white pt-12 pb-6">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Experience luxury and comfort at our premium hotels. Book your stay today and create unforgettable memories.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">123 Hotel Street, Cityville, Country</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-300">info@luxstay.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-6 border-t border-gray-700 text-center text-gray-400">
          <p>&copy; {currentYear} LuxStay Hotel Management. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
